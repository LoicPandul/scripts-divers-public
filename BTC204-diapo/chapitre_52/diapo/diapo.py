...
# Chemin des polices et des images
...
# Rectangle orange avec les tirets
def draw_dashed_rounded_rectangle(draw, xy, outline, width=line_width):
    ...
    # Segments de cercle pour les coins arrondis
...
try:
    ...
    print(f"Diapo sauvegardée dans : {output_file}")
except Exception as e:
    print(f"Erreur lors de la sauvegarde de la diapo : {e}")
